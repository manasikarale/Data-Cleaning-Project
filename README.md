...
|Cand_Office_St | Whitelisting Candidate Office State to check if the state name mentioned is correct, if not then modify it to 'Not Specified' | Data Documentation and Curation | Lambda Function |
